...
export const PLAIN_JAPANESE_COPY = {
  ...
  floodNote: {
    standard:
      '1000年に1度程度の大雨(遠賀川では12時間に592mm)で川があふれた場合の想定です。下水や側溝からあふれる内水は含みません',
    easy: '1000年(ねん)に 1回(かい)くらいの 大雨(おおあめ)で、川(かわ)が あふれた ときの よそうです。下水(げすい)や みぞから あふれる 水(みず)は 入(はい)って いません',
  },
  ...
  // 「いまの状況」の中に置くので、いま浸水しているように読める言い方を避ける
  summaryArLink: {
    standard: '現在地の想定浸水を AR で見る ›',
