...
export const PLAIN_JAPANESE_COPY = {
  ...
  landformNote: {
    standard:
      '白く抜けた所と山側は図の範囲外です。安全という意味ではありません。山側の地盤は「地震ハザード」で見られます',
    easy: '白(しろ)い ところと 山(やま)の ほうは、この 地図(ちず)に ない ところです。安全(あんぜん)という いみでは ありません。山(やま)の ほうの 地盤(じばん)は「地震(じしん)の きけん」で 見(み)られます',
  },
  areaLandslide: {
    standard: '土砂災害警戒区域',
  ...
  // 「推計」でなく「目安」「見積もり」。値は 2020 年国勢調査からの将来推計で実数ではないが、
  // 「2025年」だけ書くと直近の実数に読まれる
  areaPopulationDesc: {
    standard:
      '500mごとの人口の目安(2025年の見積もり)。地震ハザード、地形の分類とは同時に出せません',
    easy: '500m ごとの だいたいの 人(ひと)の 数(かず)(2025年に このくらいと 考(かんが)えた 数(かず))。地震(じしん)の きけんや 地形(ちけい)の 種類(しゅるい)とは いっしょには 出(だ)せません',
  },
  layerSectionMemory: {
    standard: '記憶',
    easy: 'むかしの こと',
  ...
  // 実際に数えた人数ではないこと、それでもだいたい合っていることを先に言う
  populationMeshNote: {
    standard:
      '目安の人数です。2020年の国勢調査から2025年の人数を見積もったもので、いま実際に住んでいる人数とは差があります。500m四方ごとの値です。',
    easy: 'だいたいの 人(ひと)の 数(かず)です。2020年に 国(くに)が しらべた 数(かず)を もとに、2025年は このくらいと 考(かんが)えた ものです。いま 住(す)んで いる 人(ひと)の 数(かず)とは ちがう ことが あります。500m しかくごとの 数(かず)です。',
  },
  ...
  populationLegendTitle: {
    standard: '人口の目安(500mごと)',
    easy: 'すんで いる 人(ひと)の だいたいの 数(かず)',
  },
  quakeSheetTitle: {
