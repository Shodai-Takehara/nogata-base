...
/**
 * 微地形区分の説明。名称だけでは地盤の良し悪しが読めないため、詳細シートの ⓘ で出す。
 * 土地の成り立ちと土質は若松・松岡「地形・地盤分類250mメッシュマップ」の分類基準(表1)、
 * 液状化のしやすさは国土交通省「地形区分に基づく液状化の発生傾向」の5段階による
 * (旧河道・旧池沼と自然堤防は「しやすい」、後背湿地・谷底低地・河原は「可能性がある」、
 * 山地・丘陵・砂礫質台地は「しにくい」)。揺れの大小は土質の軟らかさからの傾向で、
 * セルごとの増幅率(arv)が実際の値。市域に現れる区分だけを持つ
 */
export const JNAME_NOTE: Readonly<Record<string, { standard: string; easy: string }>> = {
  山地: {
    standard:
      '起伏が大きく、古い時代の岩石でできた高い土地。地盤は硬く、揺れは増幅されにくく、液状化もしにくい。',
    easy: 'でこぼこが 大(おお)きく、古(ふる)い 岩(いわ)で できた 高(たか)い 土地(とち)。地面(じめん)は かたく、ゆれは 大(おお)きく なりにくい。液状化(えきじょうか)も おきにくい。',
  },
  丘陵: {
    standard:
      '山地より低く、なだらかな斜面の土地。岩や軟らかい岩でできていて、揺れは増幅されにくく、液状化もしにくい。',
    easy: '山(やま)より 低(ひく)く、なだらかな さかの 土地(とち)。岩(いわ)で できていて、ゆれは 大(おお)きく なりにくい。液状化(えきじょうか)も おきにくい。',
  },
  砂礫質台地: {
    standard:
      '川沿いの一段高い平らな土地(段丘)。表層は古い時代の締まった砂礫で、揺れは増幅されにくく、液状化もしにくい。',
    easy: '川(かわ)の そばの、一段(いちだん) 高(たか)くて たいらな 土地(とち)。表面(ひょうめん)は 古(ふる)くて しまった 砂(すな)と 小石(こいし)で、ゆれは 大(おお)きく なりにくい。液状化(えきじょうか)も おきにくい。',
  },
  谷底低地: {
    standard:
      '山や丘の間を流れる川沿いの、幅のせまい低地。新しい堆積物で、下流ほど軟らかく、揺れが増幅されやすい。液状化の可能性がある。',
    easy: '山(やま)や 丘(おか)の 間(あいだ)を 流(なが)れる 川(かわ)の そばの、せまい 低(ひく)い 土地(とち)。新(あたら)しく つもった 土(つち)で、下流(かりゅう)ほど やわらかく、ゆれが 大(おお)きく なりやすい。液状化(えきじょうか)が おきる ことが ある。',
  },
  自然堤防: {
    standard:
      '川が運んだ砂が川沿いに細長く積もってできた、周りより少し高い土地。ゆるい砂なので揺れが増幅されやすく、液状化しやすい。',
    easy: '川(かわ)が はこんだ 砂(すな)が 川(かわ)に そって つもって できた、まわりより 少(すこ)し 高(たか)い 土地(とち)。ゆるい 砂(すな)なので ゆれが 大(おお)きく なりやすく、液状化(えきじょうか)が おきやすい。',
  },
  後背湿地: {
    standard:
      '自然堤防の後ろ側に広がる、低くて湿った平地。とても軟らかい粘土や泥炭でできていて、揺れが大きく増幅されやすい。液状化の可能性がある。',
    easy: '自然堤防(しぜんていぼう)の うしろに 広(ひろ)がる、低(ひく)くて しめった 土地(とち)。とても やわらかい ねん土(ど)や 泥炭(でいたん)で できていて、ゆれが とても 大(おお)きく なりやすい。液状化(えきじょうか)が おきる ことが ある。',
  },
  '旧河道・旧池沼': {
    standard:
      '昔の川の流れや池の跡で、周りより少し低い土地。極めてゆるい砂や軟らかい土でできていて、揺れが増幅されやすく、液状化しやすい。',
    easy: 'むかしの 川(かわ)や 池(いけ)の あとで、まわりより 少(すこ)し 低(ひく)い 土地(とち)。とても ゆるい 砂(すな)や やわらかい 土(つち)で できていて、ゆれが 大(おお)きく なりやすく、液状化(えきじょうか)が おきやすい。',
  },
  河原: {
    standard:
      '川の流路のうち、ふだんは水が流れていない部分。砂礫やゆるい砂でできていて、液状化の可能性がある。',
    easy: '川(かわ)の 中(なか)で、ふだんは 水(みず)が 流(なが)れて いない ところ。砂(すな)や 小石(こいし)、ゆるい 砂(すな)で できていて、液状化(えきじょうか)が おきる ことが ある。',
  },
};
