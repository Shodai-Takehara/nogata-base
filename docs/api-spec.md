...
- 図郭の内側でも分類の対象外（西の鞍手側、北東の山側）は透明ではなく、白い基図（等高線と道路の灰色の線）が不透明に描かれる。透過度 0.5 で重ねると、その部分は下の地図に白い膜がかかったように見える。凡例の注意書き「白く抜けた所は図の範囲外です」はこのため
...
- シートの凡例では各区分の下に一言（「わずかな雨でも浸水しやすく、深く長く続く」など）を添える。区分名だけでは、どの土地に水が溜まりやすいのか読めないため。文は国土地理院「治水地形分類図の内容」（<https://www.gsi.go.jp/bousaichiri/bousaichiri41051.html>）の各区分の「防災上の留意点」から起こし、平易版も持つ
